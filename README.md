...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/reprexlite-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12192&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/reprexlite-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `reprexlite` can be installed with:

```
conda install reprexlite
```

It is possible to list all of the versions of `reprexlite` available on your platform with:
